...
class IntentModel:
    def __init__(self, proprocess):
        ...
        # 의도 클래스 별 레이블
        self.labels = {0: "인사", 1: "메뉴안내", 2: "주문", 3: "예약", 4: "기타", 5: "메뉴추천", 6: "매장문의", 7: "이벤트정보", 8: "매장정보"}
    ...
    def predict_class(self, query):
        ...
        if class_check(self.menu_words, keywords):
            return "메뉴안내"
            ...
            return "주문"
        elif class_check(self.extra_food, keywords): #없는 메뉴를 말했을 경우 없다는 답변을 내놓을 것. 실제로는 Extra_food 리스트를 만드는 것이 아니라 CV_Food를 감지
            return "주문"
