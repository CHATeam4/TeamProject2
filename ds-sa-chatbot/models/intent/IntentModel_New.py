...
class IntentModel:
    def __init__(self, proprocess, nermodel, customer=None):
        ...
        self.rec_words2=["어떤"]
        self.help_words=["문의", "민원", "상담원", "고객", "센터", "서비스","지원","멤버","환불", "비밀번호", "아이디", "회원", "수신거부", "고객만족도", "기념일", "생일", "쿠폰", "재결제", "상품권"] #FAQ류 질문이 많으므로, 1:1대응되는 답변을 많이 준비해야함
        ...
        self.vague_menu_name=['음료수', '탄산', '탄산음료', '라이스', '타코', '부리또', '세트메뉴', '화이타', '햄버거', '버거', '세트', '플레터', "라이스", "수프", "스테이크","샐러드","화이타","퀘사디아","타코","부리또","버거","디저트","드링크","음료수"]
